...
{
	IMAGEMANAGER->addImage("explosion", "explosion.bmp", 832, 62, true, RGB(255, 0, 255), false);

	_effectSample = new effect;
	_effectSample->init(IMAGEMANAGER->findImage("explosion"), 32, 62, 1, 1.0f);

	EFFECTMANAGER->addEffect("explostion2", "explosion.bmp", 832, 62, 32, 62, 1, 0.5f, 2000, false);
